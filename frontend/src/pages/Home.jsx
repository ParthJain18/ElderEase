        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                ElderEase was founded on a better model of care one designed around patients which can Diagnose a problem Digitally which provides a higher level of quality and service affordably. We do this through excellent customer service, and the efficient use of technology.
          ...
          <div className="flex gap-[30px] justify-end">
            ...
            <div className='mt-[30px]'>
              <img  src={home2} alt="" className='w-full mb-[30px]' />
            ...
            <section>
              <div className="container">
                <div className="lg:w-[470px] mx-auto">
                  <h2 className='heading text-center'>Providing the best Digital & Appointment services</h2>
